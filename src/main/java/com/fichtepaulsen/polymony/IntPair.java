...
public class IntPair {
     ...
     * Returns (x,y) as int "coordinates" - top left is (0,0), bottom right (width,
     * width)
     * these coordinates are independent of the actual floating point coordinates
     * for graphics
    ...
    public static IntPair indexToPos(int index, int width) {
        ...
        return (strip == 0) ? new IntPair(index, 0)
