...
public class StreetField extends OwnableField {
    ...
    private final int[] rents = new int[6];
    private boolean allStreetsOwned;

    public StreetField(String name, int price, Color color, int rent, int house1, int house2, int house3, int house4,
            int hotel) {
        this.name = name;
        this.price = price;
        this.color = color;
    ...
    public void action(Game game) {
        ...
        // TODO handle action for street field
    }
