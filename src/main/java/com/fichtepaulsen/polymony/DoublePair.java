...
public class DoublePair {
    ...
    /*
     * gets: the one dimesnional field index, the width of the game field (amount of
     * fields / 4)
     * the lengths of the short and long sides of individual fields should be given
     * does: returns the coordinates of the top left corner of the field at the n-th
     * index
     */
    public static DoublePair indexToPoint(int position, int width, double lengthShortSide, double lengthLongSide) {
         ...
         * /*
         * ret = new DoublePair((gridCoordinates.getFirst()-1)*lengthShortSide +
         * cornerOffsetX,
         * gridCoordinates.getSecond()*lengthShortSide + cornerOffsetY);
         * 
         * }
         * else if (gridCoordinates.getSecond() == 0 || gridCoorinates.getSecond() ==
         * width) {
         * ret = topLeftCorner(cornerOffsetX, cornerOffsetY, lengthShortSide, x, y);
         * /*
         * ret = new DoublePair(gridCoordinates.getFirst()*lengthShortSide +
         * cornerOffsetX,
